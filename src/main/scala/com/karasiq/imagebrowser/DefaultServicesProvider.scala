...
import com.karasiq.imagebrowser.index.imageprocessing.cache.MapDbThumbnailsCacheProvider
import com.karasiq.imagebrowser.index.mapdb.MapDbIndexRegistryProvider
