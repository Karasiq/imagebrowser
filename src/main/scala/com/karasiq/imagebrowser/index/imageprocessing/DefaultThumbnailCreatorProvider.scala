...
import com.karasiq.imagebrowser.index.imageprocessing.cache.MapDbThumbnailsCache
...
trait DefaultThumbnailCreatorProvider extends ThumbnailCreatorProvider {
  override final val thumbnailCreator: ThumbnailCreator = new ImageIOThumbnailCreator
}
